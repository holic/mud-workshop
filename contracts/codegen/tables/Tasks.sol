...
library Tasks {
   ...
   */
  function getCreatedAt(uint256 id) internal view returns (uint256 createdAt) {
   ...
   * @notice Get createdAt.
   */
  function _getCreatedAt(uint256 id) internal view returns (uint256 createdAt) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function setCreatedAt(uint256 id, uint256 createdAt) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set createdAt.
   */
  function _setCreatedAt(uint256 id, uint256 createdAt) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function getCompletedAt(uint256 id) internal view returns (uint256 completedAt) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get completedAt.
   */
  function _getCompletedAt(uint256 id) internal view returns (uint256 completedAt) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function setCompletedAt(uint256 id, uint256 completedAt) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Set completedAt.
   */
  function _setCompletedAt(uint256 id, uint256 completedAt) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function get(uint256 id) internal view returns (TasksData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   * @notice Get the full data.
   */
  function _get(uint256 id) internal view returns (TasksData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(id));
   ...
   */
  function set(uint256 id, uint256 createdAt, uint256 completedAt, string memory description) internal {
   ...
   * @notice Set the full data using individual values.
   */
  function _set(uint256 id, uint256 createdAt, uint256 completedAt, string memory description) internal {
    bytes memory _staticData = encodeStatic(createdAt, completedAt);
   ...
   */
  function set(uint256 id, TasksData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(uint256 id, TasksData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.createdAt, _table.completedAt);
